        ...
        <section className="py-24 bg-white dark:bg-[#121212] overflow-hidden relative">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h3 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-10 leading-tight">
              "The multidisciplinary approach at SchoolDesk prepared me for a
              career that didn't even exist when I started my degree."
            </h3>
            <div className="flex flex-col items-center">
              <img
                src="https://picsum.photos/seed/schooldesk-student/100/100"
                alt="Student"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-linear-to-r from-gray-50 to-white dark:from-[#1c1c1c] dark:to-[#2a2a2a] rounded-[3rem] p-12 md:p-20 text-center border border-gray-200 dark:border-gray-800 relative overflow-hidden shadow-xl dark:shadow-none">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <button className="bg-primary text-primary-foreground px-10 py-5 rounded-xl font-bold text-lg hover:bg-primary/90 transition-all transform hover:scale-105 shadow-lg shadow-[rgba(30,157,241,0.3)]">
                  Apply Now
                </button>
                <button className="bg-transparent border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white px-10 py-5 rounded-xl font-bold text-lg hover:border-primary hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
                  Contact Admissions
                </button>
              </div>
            </div>
