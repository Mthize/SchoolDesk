    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button className="bg-primary text-primary-foreground px-5 py-2 rounded-md font-bold hover:bg-primary/85 transition-all transform hover:scale-105">
              Apply Now
            </button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-[#1c1c1c] border-b border-gray-200 dark:border-gray-800 px-4 pt-2 pb-6 space-y-4">
          <a
            href="#home"
            className="block text-gray-600 dark:text-gray-300 hover:text-primary text-lg font-medium"
          >
            Overview
          </a>
          <a
