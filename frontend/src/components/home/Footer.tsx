    ...
    <footer className="pt-20 pb-10 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white dark:bg-[#1c1c1c] border border-gray-200 dark:border-gray-800 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all text-gray-500 dark:text-gray-400 shadow-sm"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="#"
                  className="text-gray-600 dark:text-gray-500 hover:text-primary transition-colors"
                >
                  Undergraduate
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <button className="bg-primary text-primary-foreground px-4 py-3 rounded-r-lg font-bold hover:bg-primary/90 transition-colors">
                Join
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
          <p>© 2025 SchoolDesk. All rights reserved.</p>
          ...
          <button
            ...
            className="mt-6 md:mt-0 p-3 rounded-full bg-white dark:bg-[#1c1c1c] border border-gray-200 dark:border-gray-800 hover:border-primary transition-all group shadow-sm"
          >
            <ArrowUp className="w-5 h-5 group-hover:text-primary text-gray-400" />
          </button>
        </div>
      </div>
    </footer>
