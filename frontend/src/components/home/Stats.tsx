        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <AreaChart data={data}>
                  <defs>
                    <linearGradient id="colorGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#1e9df1" stopOpacity={0.3} />
          ...
          <div className="grid grid-cols-1 gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-white dark:bg-[#1c1c1c] p-6 rounded-2xl border border-gray-200 dark:border-gray-800 flex items-start space-x-4 hover:border-primary/30 transition-all cursor-default shadow-sm hover:shadow-md"
              >
                <div
